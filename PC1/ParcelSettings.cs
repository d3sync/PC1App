...
public partial class ParcelSettings : Form
{
    ...
    private readonly ReceivedParcels rr;
    ...
    private void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        rr.IsCompleted = int.Parse(cmbStatus.SelectedValue.ToString());
        if (rr.IsCompleted == 3) rr.Comments = $"{rr.Comments} ΑΚΥΡΩΘΗΚΕ {DateTime.Now.ToString("d")}";
